...
public class CONNACK implements Message {
    ...
    public static enum Code {
        ...
        CONNECTION_HC_OK,
        CONNECTION_REFUSED_BAD_KEEP_ALIVE,
        CONNECTION_REFUSED_SERVER_SHEDDING_LOAD,
        CONNECTION_REFUSED_PROTOCOL_VIOLATION,
        CONNECTION_REFUSED_BAD_CONNECT_HASH,
        CONNECTION_REFUSED_AUTH_NOT_AVAILABLE;
    }
