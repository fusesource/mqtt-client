...
public class ConnectionBuilder {
    ...
    private org.fusesource.mqtt.client.callback.ConnectionBuilder next;

    public ConnectionBuilder(org.fusesource.mqtt.client.callback.ConnectionBuilder next) {
        this.next = next;
    }
    ...
    public Future<Connection> connect() {
        ...
        next.connect(new Callback<org.fusesource.mqtt.client.callback.Connection>() {
            public void failure(Throwable value) {
                future.failure(value);
            }

            public void success(org.fusesource.mqtt.client.callback.Connection value) {
